        ...
        <div className="about_container">
          <div className="about_container_content">
            <div className="about_container_content_bloc">
              ...
              <Markdown>
                Bienvenue sur **Portail GéoCode**, votre compagnon de confiance
                pour une mobilité électrique pratique et sans souci. Notre
                plateforme innovante a été conçue pour simplifier votre
                expérience de recharge de véhicules électriques, vous permettant
                de trouver rapidement et facilement les bornes de recharge les
                plus proches, où que vous soyez.
              </Markdown>
            </div>
            <div className="about_container_content_bloc">
              <h3>Notre Mission</h3>
              <Markdown>
                Chez GéoCode, notre mission est de faciliter la transition vers
                une mobilité durable en mettant à votre disposition une carte
                interactive de bornes de recharge. Nous croyons fermement en un
                avenir où chaque conducteur électrique peut accéder à des
                solutions de recharge efficaces, contribuant ainsi à la
            ...
            <div className="about_container_content_bloc">
              ...
              <Markdown>
                \- **Personnalisation du Profil :** Créez un profil utilisateur
                pour des recommandations de recharge personnalisées en fonction
                de vos préférences et de l'autonomie de votre véhicule.
              </Markdown>
            </div>
            <div className="about_container_content_bloc">
              ...
              <Markdown>
                ...
                construction d'un avenir plus vert. Nous croyons en la puissance
                des petites actions pour créer un impact significatif, et votre
                choix de conduire un véhicule électrique et d'utiliser notre
                service de localisation de bornes de recharge contribue à rendre
