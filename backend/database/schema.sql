...
INSERT INTO user (nom, prenom, rue, code_postal,ville, email, password, connection, nb_vehicule, admin, anniversaire, inscription, derniere_maj)
 ...
 ('save', 'baptiste', 'rue dupont', 75000, 'Arnac', 'baptiste@save.fr', '$argon2id$v=19$m=19456,t=2,p=1$x0IxEYRVCwCRVt3sNkETeA$JlNKV1ORQzWEf6mD7F+70Iwwb3GU8vBHId0G55Kj1Yc', '2023-01-09', 1, true, '1990-01-01', '2023-01-09', '2023-01-09'),
